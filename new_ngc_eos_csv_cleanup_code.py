...
dataset.to_csv(r'newCoolTermCapture.csv')
...
**Redo all over again for
 datalogger_ACM0_2020-07-28-15_53_54.csv**
"""
...
"""Deleting columns that only have strings in them"""
...
"""**Rename those bad boiz**"""

dataset2.rename(columns={0: "Date & Time", 2: "Latitude", 4: "Longitude"},inplace=True)
dataset2

"""**Save dataframe to a new CSV**"""

dataset2.to_csv(r'DATALOGGER_ACM_NEW.csv')